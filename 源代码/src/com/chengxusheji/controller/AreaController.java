...
public class AreaController extends BaseController {
	...
	public void listAll(HttpServletResponse response) throws Exception {
		...
		for(Area area:areaList) {
			...
			jsonArea.accumulate("areanName", area.getAreanName());
			jsonArray.put(jsonArea);
		}
	...
	public String delete(@PathVariable Integer areaId,HttpServletRequest request) throws UnsupportedEncodingException {
		  try {
			  areaService.deleteArea(areaId);
	            request.setAttribute("message", "旅游类别删除成功!");
	            return "message";
	        } catch (Exception e) { 
	            e.printStackTrace();
	            request.setAttribute("error", "旅游类别删除失败!");
				return "error";
