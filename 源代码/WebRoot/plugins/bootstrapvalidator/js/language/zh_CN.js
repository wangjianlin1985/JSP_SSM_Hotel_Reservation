(function ($) {
    ...
    $.fn.bootstrapValidator.i18n = $.extend(true, $.fn.bootstrapValidator.i18n, {
        ...
        iban: {
            ...
            countryNotSupported: '不支持 %s 国家或旅游类别',
            country: '请输入有效的 %s 国家或旅游类别的IBAN(国际银行账户)号码',
            countries: {
                AD: '安道​​尔',
                AE: '阿联酋',
                AL: '阿尔巴尼亚',
        ...
        id: {
            ...
            countryNotSupported: '不支持 %s 国家或旅游类别',
            country: '请输入有效的 %s 国家或旅游类别的身份证件号码',
            countries: {
                BA: '波黑',
                BG: '保加利亚',
                BR: '巴西',
        ...
        vat: {
            ...
            countryNotSupported: '不支持 %s 国家或旅游类别',
            country: '请输入有效的 %s 国家或旅游类别的VAT(税号)',
            countries: {
                AT: '奥地利',
                BE: '比利时',
                BG: '保加利亚',
