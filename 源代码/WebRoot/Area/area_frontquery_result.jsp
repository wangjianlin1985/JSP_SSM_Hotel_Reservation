		...
		<div class="col-md-12 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#areaListPanel" aria-controls="areaListPanel" role="tab" data-toggle="tab">旅游类别列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>Area/area_frontAdd.jsp" style="display:none;">添加旅游类别</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>旅游类别id</td><td>旅游类别名称</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<areaList.size();i++) {
					    	            		...
					    	            		Area area = areaList.get(i); //获取到旅游类别对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
 											<td><%=area.getAreaId() %></td>
 											<td><%=area.getAreanName() %></td>
 											<td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;旅游类别信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="area_areaId_edit" class="col-md-3 text-right">旅游类别id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="area_areaId_edit" name="area.areaId" class="form-control" placeholder="请输入旅游类别id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="area_areanName_edit" class="col-md-3 text-right">旅游类别名称:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="area_areanName_edit" name="area.areanName" class="form-control" placeholder="请输入旅游类别名称">
			 </div>
		  </div>
		</form> 
