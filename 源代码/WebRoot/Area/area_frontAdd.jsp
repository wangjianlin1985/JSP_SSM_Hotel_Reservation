		...
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	<li role="presentation" ><a href="<%=basePath %>Area/frontlist">旅游类别列表</a></li>
			    	<li role="presentation" class="active"><a href="#areaAdd" aria-controls="areaAdd" role="tab" data-toggle="tab">添加旅游类别</a></li>
				</ul>
				<!-- Tab panes -->
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="areaAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="area_areanName" class="col-md-2 text-right">旅游类别名称:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="area_areanName" name="area.areanName" class="form-control" placeholder="请输入旅游类别名称">
							 </div>
						  </div>
				          <div class="form-group">
