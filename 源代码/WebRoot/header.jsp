...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">SSM旅游网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Minsu/frontlist?areaObj.areaId=1">热门景点</a></li>
                <li><a href="<%=basePath %>Minsu/frontlist?areaObj.areaId=2">酒店</a></li>
                <li><a href="<%=basePath %>Minsu/frontlist?areaObj.areaId=3">热销产品</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Comment/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我的评论</a></li>
