...
<%
    ...
    Minsu minsuObj = (Minsu)request.getAttribute("minsuObj");
...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>评论id</td><td>被评茂名旅游</td><td>评论内容</td><td>评论时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											...
 											<td><%=comment.getMinsuObj().getMinsuName() %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="commentQueryForm" id="commentQueryForm" action="<%=basePath %>Comment/userFrontlist" class="mar_t15" method="post">
            <div class="form-group">
            	<label for="minsuObj_minsuId">被评茂名旅游：</label>
                <select id="minsuObj_minsuId" name="minsuObj.minsuId" class="form-control">
                	<option value="0">不限制</option>
	 				<%
	 				for(Minsu minsuTemp:minsuList) {
	 					String selected = "";
 					if(minsuObj!=null && minsuObj.getMinsuId()!=null && minsuObj.getMinsuId().intValue()==minsuTemp.getMinsuId().intValue())
 						selected = "selected";
	 				%>
 				 <option value="<%=minsuTemp.getMinsuId() %>" <%=selected %>><%=minsuTemp.getMinsuName() %></option>
	 				<%
	 				}
	 				%>
 			</select>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="comment_minsuObj_minsuId_edit" class="col-md-3 text-right">被评茂名旅游:</label>
		  	 <div class="col-md-9">
