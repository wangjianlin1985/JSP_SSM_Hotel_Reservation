				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="commentAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="comment_minsuObj_minsuId" class="col-md-2 text-right">被评茂名旅游:</label>
						  	 <div class="col-md-8">
							    <select id="comment_minsuObj_minsuId" name="comment.minsuObj.minsuId" class="form-control">
							    </select>
						  	 </div>
						  </div>
						  <div class="form-group">
