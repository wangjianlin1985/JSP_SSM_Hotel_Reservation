...
<div id="comment_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="commentQueryForm" method="post">
			被评茂名旅游：<input class="textbox" type="text" id="minsuObj_minsuId_query" name="minsuObj.minsuId" style="width: auto"/>
...
<div id="commentEditDiv">
	<form id="commentEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			<span class="label">被评茂名旅游:</span>
			<span class="inputControl">
				<input class="textbox"  id="comment_minsuObj_minsuId_edit" name="comment.minsuObj.minsuId" style="width: auto"/>
			</span>
		</div>
		<div>
