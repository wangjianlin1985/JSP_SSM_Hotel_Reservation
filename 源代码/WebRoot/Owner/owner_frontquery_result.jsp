...
<%
    ...
    String name = (String)request.getAttribute("name"); //茂名市区线路查询关键字
...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Owner/frontlist">茂名市区线路信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>Owner/owner_frontAdd.jsp" style="display:none;">添加茂名市区线路</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
				...
				for(int i=0;i<ownerList.size();i++) {
            		...
            		Owner owner = ownerList.get(i); //获取到茂名市区线路对象
            		String clearLeft = "";
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="ownerQueryForm" id="ownerQueryForm" action="<%=basePath %>Owner/frontlist" class="mar_t15" method="post">
			...
			<div class="form-group">
				<label for="name">茂名市区线路:</label>
				<input type="text" id="name" name="name" value="<%=name %>" class="form-control" placeholder="请输入茂名市区线路">
			</div>
			<div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;茂名市区线路信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="owner_name_edit" class="col-md-3 text-right">茂名市区线路:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="owner_name_edit" name="owner.name" class="form-control" placeholder="请输入茂名市区线路">
			 </div>
		  </div>
		  <div class="form-group">
