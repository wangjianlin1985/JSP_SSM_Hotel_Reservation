...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>Minsu/frontlist">茂名旅游信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">茂名旅游id:</div>
		<div class="col-md-10 col-xs-6"><%=minsu.getMinsuId()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">所在旅游类别:</div>
		<div class="col-md-10 col-xs-6"><%=minsu.getAreaObj().getAreanName() %></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">茂名旅游名称:</div>
		<div class="col-md-10 col-xs-6"><%=minsu.getMinsuName()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">茂名旅游照片:</div>
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">茂名旅游介绍:</div>
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">茂名市区线路:</div>
