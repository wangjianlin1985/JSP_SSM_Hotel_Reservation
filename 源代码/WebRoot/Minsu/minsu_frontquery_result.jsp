...
<%
    ...
    String minsuName = (String)request.getAttribute("minsuName"); //茂名旅游名称查询关键字
%>
<!DOCTYPE html>
<html>
<head>
...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Minsu/frontlist">茂名旅游信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>Minsu/minsu_frontAdd.jsp" style="display:none;">添加茂名旅游</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
				...
				for(int i=0;i<minsuList.size();i++) {
            		...
            		Minsu minsu = minsuList.get(i); //获取到茂名旅游对象
            		String clearLeft = "";
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Minsu/<%=minsu.getMinsuId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=minsu.getMinsuPhoto()%>" /></a>
			     <div class="showFields">
			     	<div class="field">
	            		茂名旅游id:<%=minsu.getMinsuId() %>
			     	</div>
			     	<div class="field">
	            		所在旅游类别:<%=minsu.getAreaObj().getAreanName() %>
			     	</div>
			     	<div class="field">
	            		茂名旅游名称:<%=minsu.getMinsuName() %>
			     	</div>
			     	<div class="field">
	            		价格:<%=minsu.getPrice() %>
			     	</div>
			     	<div class="field">
	            		茂名市区线路:<%=minsu.getOwnerObj().getName() %>
			     	</div>
			     	<div class="field">
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="minsuQueryForm" id="minsuQueryForm" action="<%=basePath %>Minsu/frontlist" class="mar_t15" method="post">
            <div class="form-group">
            	<label for="ownerObj_ownerUserName">茂名市区线路：</label>
            ...
            <div class="form-group">
            	<label for="areaObj_areaId">所在旅游类别：</label>
			...
			<div class="form-group">
				<label for="minsuName">茂名旅游名称:</label>
				<input type="text" id="minsuName" name="minsuName" value="<%=minsuName %>" class="form-control" placeholder="请输入茂名旅游名称">
			</div>
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;茂名旅游信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="minsu_minsuId_edit" class="col-md-3 text-right">茂名旅游id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="minsu_minsuId_edit" name="minsu.minsuId" class="form-control" placeholder="请输入茂名旅游id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="minsu_areaObj_areaId_edit" class="col-md-3 text-right">所在旅游类别:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="minsu_minsuName_edit" class="col-md-3 text-right">茂名旅游名称:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="minsu_minsuName_edit" name="minsu.minsuName" class="form-control" placeholder="请输入茂名旅游名称">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="minsu_minsuPhoto_edit" class="col-md-3 text-right">茂名旅游照片:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="minsu_price_edit" class="col-md-3 text-right">价格:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="minsu_price_edit" name="minsu.price" class="form-control" placeholder="请输入价格">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="minsu_minsuDesc_edit" class="col-md-3 text-right">茂名旅游介绍:</label>
		  	 <div class="col-md-9">
			 	<textarea name="minsu.minsuDesc" id="minsu_minsuDesc_edit" style="width:100%;height:500px;"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="minsu_ownerObj_ownerUserName_edit" class="col-md-3 text-right">茂名市区线路:</label>
		  	 <div class="col-md-9">
...
<script>
//实例化编辑器
var minsu_minsuDesc_edit = UE.getEditor('minsu_minsuDesc_edit'); //茂名旅游介绍编辑器
	...
	$.ajax({
		...
		success : function (minsu, response, status) {
			if (minsu) {
				...
				minsu_minsuDesc_edit.setContent(minsu.minsuDesc, false);
